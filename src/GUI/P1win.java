 ...
 * @author Spac3
 */
public class P1win extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/P1win.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P1win.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
